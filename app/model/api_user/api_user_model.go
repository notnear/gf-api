...
// arModel is a active record design model for table api_user operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of api_user.
	Table = "api_user"
	// Model is the model object of api_user.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table api_user.
	Columns = struct {
		Id       string //
		Mobile   string // 电话号码
		Nickname string // 昵称
		Avatar   string // 头像
		Sex      string // 性别 0 未知 1男 2女
		Status   string // 状态
